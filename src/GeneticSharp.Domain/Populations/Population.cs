...
namespace GeneticSharp.Domain.Populations
{
    ...
    public class Population : IPopulation
    {
        ...
        /// <summary>
        /// Optionally defines a set of specific individuals to insert into the initial generation additionally to those generated by the AdamChromosome
        /// </summary>
        public ICollection<IChromosome> EveChromosomes { get; set; } = new IChromosome[] { };
        #endregion
        ...
        public virtual void CreateInitialGeneration()
        {
            ...
            var chromosomes = CreateNewChromosomes(MinSize - EveChromosomes.Count);
            foreach (var eveChromosome in EveChromosomes)
            {
                if (eveChromosome == null)
                {
                    throw new InvalidOperationException("The Eve chromosomes must be non null, please, check your population creation code.");
                }
                chromosomes.Add(eveChromosome);
            }
        ...
        /// <summary>
        /// CreateNewChromosomes calls CreateNewChromosome to generate a list of Adam based new chromosomes. It is kept virtual to allow for a parallel implementation
        /// </summary>
        /// <param name="nbChromosomes">the number of chromosomes to generate</param>
        /// <returns>a list of new chromosomes</returns>
        protected virtual IList<IChromosome> CreateNewChromosomes(int nbChromosomes)
        {
            var chromosomes = new List<IChromosome>(nbChromosomes);
        ...
        /// <summary>
        /// Creates a new chromosome by calling the CreateNew method on the AdamChromosome instance
        /// </summary>
        /// <returns>a new Chromosome object</returns>
        public virtual IChromosome CreateNewChromosome()
        {
